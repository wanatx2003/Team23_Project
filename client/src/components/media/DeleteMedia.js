      ...
      <div className="delete-confirmation-card">
        ...
        <div className="device-info-box">
          <div className="device-info-header">
            ...
            <span className="device-type-badge">{mediaData.Type}</span>
          </div>
          
          <div className="device-info-grid">
            <div className="info-item">
              <span className="info-label">Author:</span>
              <span className="info-value">{mediaData.Author}</span>
            </div>
            <div className="info-item">
              <span className="info-label">Genre:</span>
              <span className="info-value">{mediaData.Genre}</span>
            </div>
            <div className="info-item">
              <span className="info-label">Publication Year:</span>
              <span className="info-value">{mediaData.PublicationYear}</span>
            </div>
            <div className="info-item">
              <span className="info-label">Language:</span>
              <span className="info-value">{mediaData.Language}</span>
            </div>
            <div className="info-item">
              <span className="info-label">Total Copies:</span>
              <span className="info-value">{mediaData.TotalCopies}</span>
            </div>
            <div className="info-item">
              <span className="info-label">Available Copies:</span>
              <span className="info-value">{mediaData.AvailableCopies}</span>
            </div>
          </div>
        </div>
